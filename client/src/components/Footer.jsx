      ...
      <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
          ...
          <p className="mt-6 text-sm">
            Experince the power of AI with QuickAi. <br/> transform your content cration with our suite of premium AI tools. write articles,generate images, and enhance your workflow. 
          </p>
        </div>
