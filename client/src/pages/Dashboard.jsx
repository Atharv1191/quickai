...
import CrationItems from '../components/CrationItems'
    ...
    <div className='h-full overflow-y-scroll p-6'>
        <div className='flex justify-start gap-4 flex-wrap'>
            ...
            <div className='flex justify-between items-center w-72 p-4 px-6 bg-white rounded-xl border border-gray-200'>
                ...
                <div className='w-10 h-10 rounded-lg bg-gradient-to-br from-[#FF61CF] to-[#9E53EE] flex justify-center items-center'>
        ...
        {loading ? (
            ...
            {
                creations.map((item)=>(
                    <CrationItems key={item.id} item={item}/>
                ))
            }
        </div>)}
