...
const GenereateImages = () => {
  const imageStyles = [
    "Realistic", "Ghibil style", "Anime Style", "Cartoon style",
      ...
      >
        ...
        <div className="my-6 flex items-center gap-2">
          <label className="relative cursor-pointer inline-block w-9 h-5">
            ...
            />
            <div className="w-full h-full bg-slate-300 rounded-full peer-checked:bg-green-500 transition" />
...
export default GenereateImages;
